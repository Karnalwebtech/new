...
import { ProductCreateForm } from "@/modules/main/products/create/product-create-form";
...
export default function Page() {
  return (
    <>
      <Header
        breadcrumbData={[
          { label: "Dashboard", path: "/dashboard/products" },
          { label: "Blog post", path: "/dashboard/products/create" },
        ]}
      />
