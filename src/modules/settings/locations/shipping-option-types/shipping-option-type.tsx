...
import { ShippingOptionTypes } from "@/types/shipping-types";
import { useDeleteShippingOptionTypeMutation, useGetAllShippingOptionTypeDataQuery } from "@/state/shipping-option-type-api";
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem
                ...
                onClick={() =>
                  router.push(`/settings/locations/shipping-option-types/${item?.id}/edit`)
                }
              >
...
const ShippingOptionType = () => {
  ...
  ] = useDeleteShippingOptionTypeMutation();
  const { data, isLoading, error } = useGetAllShippingOptionTypeDataQuery({
  ...
  useHandleNotifications({
    ...
    successMessage: `Shipping option type delete successfully!`,
  });
  ...
  const DeleteHandler = useCallback(async () => {
    if (deletedId) await deleteShippingOptionType({ id: deletedId });
  }, [deleteShippingOptionType, deletedId]);
  ...
  return (
    ...
    >
      <div className="container mx-auto py-8">
        <PageHeander2
          headerTitle={"Shipping Option Types"}
          headerDescription="Organize your shipping options into types."
          ...
          subHeader={true}
          navLink={`/settings/locations/shipping-option-types/create`}
        />
      ...
      <AnimatePresence>
        {isOpen && (
          <AlertDialogComponenet
            ...
            setIsOpen={setIsOpen}
            title="Are you sure?"
            description="This action cannot be undone. This will permanently delete the Shipping option type."
...
export default memo(ShippingOptionType);
