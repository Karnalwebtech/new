...
import { useDeleteShippingProfileMutation, useGetAllShippingProfileDataQuery } from "@/state/shipping-profile-api";
import NoRecordsCard from "@/components/cards/no-records-card";
import { ShippingProfileTypes } from "@/types/shipping-types";
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem
                ...
                onClick={() =>
                  router.push(`/settings/locations/shipping-profiles/${item?.id}/edit`)
                }
              >
...
const ShippingProfile = () => {
  ...
  const { data, isLoading, error } = useGetAllShippingProfileDataQuery({
  ...
  useHandleNotifications({
    ...
    successMessage: `Shipping profile delete successfully!`,
  });
  ...
  const DeleteHandler = useCallback(async () => {
    if (deletedId) await deleteShippingProfile({ id: deletedId });
  }, [deleteShippingProfile, deletedId]);
  ...
  return (
    ...
    >
      <div className="container mx-auto py-8">
        <PageHeander2
          headerTitle={"Shipping Profiles"}
          headerDescription="Group products with similar shipping requirements into profiles."
          ...
          subHeader={true}
          navLink={`/settings/locations/shipping-profiles/create`}
        />
