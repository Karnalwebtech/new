...
Row.displayName = "Row";
interface PublishableApiSalesChanelsListProps {
  pageId?: string;
  id?: string;
}
const PublishableApiSalesChanelsList = ({
  pageId,
  id,
}: PublishableApiSalesChanelsListProps) => {
...
export default memo(PublishableApiSalesChanelsList);
