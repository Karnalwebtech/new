...
import { CountryStateCityType } from "@/types/country-state-city-type";
      ...
      <div className="container mx-auto py-8">
        ...
        >
          <div className="bg-card border border-border rounded-lg overflow-hidden shadow-sm relative">
            ...
            <Shadcn_table
              table_header={["checkbox", "Code", "Name"]}
...
export default memo(CountryStateCityTable);
