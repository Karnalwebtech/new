...
Row.displayName = "Row";
interface ApiSalesChanelsTableProps {
  pageId?: string;
  type?: string;
}
const ApiSalesChanelsTable = ({ pageId, type }: ApiSalesChanelsTableProps) => {
  ...
  const {
    data: apiKeyFetch,
    isLoading: apiKeyFetchLoading,
    error: apiKeyError,
  } = useGetApiKeyDetailsQuery({ id: pageId as string }, { skip: !pageId });
  const {
    data: selectedFetchData,
    isLoading: selectedFetchDataLoading,
    error: selectedFetachError,
  ...
  const tableBody = useMemo(() => {
    ...
    return filteredItems.map((item, i) => (
      <Row
        ...
        isDisabled={
          Array.isArray(selectedIds) && selectedIds.includes(item._id!)
        }
...
export default memo(ApiSalesChanelsTable);
