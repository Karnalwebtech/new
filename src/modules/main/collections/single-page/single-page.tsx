...
import { useGetSingleQuery } from "@/state/product-collections-api";
...
interface SingleProductCollectionPageProps {
  ItemId: string;
}

const SingleProductCollectionPage = ({
  ItemId,
}: SingleProductCollectionPageProps) => {
  const [selectedProducts, setSelectedProducts] = useState<string[]>([]);
  const { data, isLoading } = useGetSingleQuery({ id: ItemId });
                  ...
                  <DropdownMenu>
                    ...
                    >
                      <DropdownMenuItem className="cursor-pointer"
                        onClick={() =>
                          router.push(
                            `/dashboard/collections/${result?.id}/edit`
                          )
                        }
                      >
                        Edit Collection
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="border-t-2 p-4">
                    ...
                    <p className="text-sm text-blue-600 hover:text-blue-800 transition-colors cursor-pointer">
                      /
                      <Link href={`${baseUrl}/${result?.handle}`}>
                        {result?.handle}
                      </Link>
                    </p>
                  </div>
...
export default SingleProductCollectionPage;
