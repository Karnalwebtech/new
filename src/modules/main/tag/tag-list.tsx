...
import { useDeletetagMutation, useGetAllTagQuery } from "@/state/tag-api";
interface TagListProps{
    type?:string;
}
const TagList = ({type="post"}:TagListProps) => {
            ...
            <TableRow key={index}>
                ...
                <TableCell>
                    <LinkTooltip
                        Icon={Pencil}
                        description={"Edit"}
                        path={`/dashboard/${type}/tag/${item.id}`}
