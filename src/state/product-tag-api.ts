...
export const productTagApi = createApi({
  ...
  endpoints: (build) => ({
    ...
    >({
      ...
      providesTags: [{ type: "productTagApi", id: "LIST" }],
    }),
    addProductTag: build.mutation<void, ProductTagType>({
      query: (data) => {
      ...
      invalidatesTags: [{ type: "productTagApi", id: "LIST" }],
    }),
